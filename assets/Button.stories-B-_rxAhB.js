...
}`,...A.parameters?.docs?.source},description:{story:"Circle shape button (typically used with icons).",...A.parameters?.docs?.description}}};z.parameters={...z.parameters,docs:{...z.parameters?.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    gap: '16px',
    alignItems: 'center'
...
}`,...z.parameters?.docs?.source},description:{story:"All shapes displayed together.",...z.parameters?.docs?.description}}};P.parameters={...P.parameters,docs:{...P.parameters?.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    gap: '16px',
    alignItems: 'center'
...
}`,...P.parameters?.docs?.source},description:{story:"Circle shape in different sizes.",...P.parameters?.docs?.description}}};W.parameters={...W.parameters,docs:{...W.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...G.parameters?.docs?.source},description:{story:'Disabled primary, icon-only — on dark theme the icon should render white (`currentColor` / `--memori-surface-contrast-inverse`).\nStorybook dark background applies `data-theme="dark"` on the document root (see `.storybook/preview.ts`).',...G.parameters?.docs?.description}}};_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  args: {
    variant: 'primary',
    icon: <Download />,
    children: 'Download',
...
}`,..._.parameters?.docs?.source},description:{story:"Disabled primary with icon and label — same dark-theme white content as {@link DisabledPrimaryIconOnlyDark}.",..._.parameters?.docs?.description}}};R.parameters={...R.parameters,docs:{...R.parameters?.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
...
}`,...R.parameters?.docs?.source},description:{story:"Dark theme regression: disabled primary icon-only (white icon) and disabled danger (error background).",...R.parameters?.docs?.description}}};M.parameters={...M.parameters,docs:{...M.parameters?.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    gap: '16px',
    flexWrap: 'wrap'
...
}`,...M.parameters?.docs?.source},description:{story:"All variants including new ones displayed together.",...M.parameters?.docs?.description}}};T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    flexDirection: 'column',
    gap: '24px'
...
}`,...T.parameters?.docs?.source},description:{story:"Comprehensive example showing all features.",...T.parameters?.docs?.description}}};const dr=["Primary","Secondary","Outline","Small","Medium","Large","FullWidth","WithShadow","Disabled","DisabledOutline","AllVariants","Link","AllSizes","Ghost","Danger","DangerProp","Loading","LoadingVariants","WithIconLeft","WithIconRight","IconOnly","IconButtons","RoundShape","CircleShape","AllShapes","CircleSizes","Active","ActiveVariants","DisabledGhost","DisabledDanger","DisabledDangerSemanticBackground","DisabledPrimaryIconOnlyDark","DisabledPrimaryWithIconDark","DisabledContextsDark","AllVariantsComplete","Showcase"];export{W as Active,L as ActiveVariants,z as AllShapes,y as AllSizes,h as AllVariants,M as AllVariantsComplete,A as CircleShape,P as CircleSizes,x as Danger,b as DangerProp,u as Disabled,R as DisabledContextsDark,C as DisabledDanger,O as DisabledDangerSemanticBackground,I as DisabledGhost,m as DisabledOutline,G as DisabledPrimaryIconOnlyDark,_ as DisabledPrimaryWithIconDark,l as FullWidth,v as Ghost,k as IconButtons,D as IconOnly,c as Large,g as Link,B as Loading,j as LoadingVariants,d as Medium,s as Outline,n as Primary,w as RoundShape,i as Secondary,T as Showcase,o as Small,S as WithIconLeft,f as WithIconRight,p as WithShadow,dr as __namedExportsOrder,or as default};
