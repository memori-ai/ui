...
}`,...h.parameters?.docs?.source},description:{story:"Link variant — underlined text using primary color (for actions styled as links).",...h.parameters?.docs?.description}}};y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    gap: '16px',
    alignItems: 'center'
