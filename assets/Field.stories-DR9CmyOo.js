...
}`,...p.parameters?.docs?.source},description:{story:"Built-in validation with validate callback and validationMode.",...p.parameters?.docs?.description}}};const G=["Default","Required","WithError","Disabled","WithDescription","Composition","Validation"];export{c as Composition,l as Default,d as Disabled,t as Required,p as Validation,n as WithDescription,s as WithError,G as __namedExportsOrder,q as default};
