import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as n}from"./iframe-CC-EOf8e.js";import{c as N}from"./index-DrktbJ3p.js";import{u as D,a as _,c as V}from"./useRenderElement-D03DcVvj.js";import{b as O,n as H}from"./createBaseUIEventDetails-CleEspmA.js";import{F as L}from"./LabelableContext-DaJ0bkc_.js";import{u as Y}from"./useValueChanged-_FAxEOfT.js";import{F as t}from"./Field-D-QPc55i.js";import{I as s}from"./Input-D0e0iBjn.js";import{B as u}from"./Button-B4-D1wbT.js";import"./preload-helper-Ct5FWWRu.js";import"./index-Bw48Ob8W.js";import"./index-B534SnbS.js";import"./element-D1H5LOPu.js";import"./useOnMount-aNS7vw6n.js";import"./useBaseUiId-BJUK5w58.js";import"./useId-BKdEnpdl.js";import"./useControlled-j73fdSyh.js";import"./useLabelableId-BZh8I77g.js";import"./useButton-QwI6WhU6.js";import"./loader-circle-LdFNQ5lj.js";import"./createLucideIcon-BwJRafyi.js";const K=n.forwardRef(function(d,j){const{render:C,className:I,validationMode:g="onSubmit",errors:p,onSubmit:B,onFormSubmit:R,...E}=d,l=n.useRef({fields:new Map}),c=n.useRef(!1),x=n.useRef(!1),b=D(o=>{o&&(o.focus(),o.tagName==="INPUT"&&o.select())}),[a,T]=n.useState(p);Y(p,()=>{T(p)}),n.useEffect(()=>{if(!c.current)return;c.current=!1;const o=Array.from(l.current.fields.values()).filter(i=>i.validityData.state.valid===!1);o.length&&b(o[0].controlRef.current)},[a,b]);const k=_("form",d,{ref:j,props:[{noValidate:!0,onSubmit(o){x.current=!0;let i=Array.from(l.current.fields.values());i.forEach(f=>{f.validate()}),i=Array.from(l.current.fields.values());const M=i.filter(f=>!f.validityData.state.valid);if(M.length)o.preventDefault(),b(M[0].controlRef.current);else if(c.current=!0,B?.(o),R){o.preventDefault();const f=i.reduce((q,P)=>(P.name&&(q[P.name]=P.getValue()),q),{});R(f,O(H,o.nativeEvent))}}},E]}),A=D(o=>{if(o&&a&&V.hasOwnProperty.call(a,o)){const i={...a};delete i[o],T(i)}}),W=n.useMemo(()=>({formRef:l,validationMode:g,errors:a??V,clearErrors:A,submitAttemptedRef:x}),[l,g,a,A]);return e.jsx(L.Provider,{value:W,children:k})}),Q="styles-module__root___oyTaA",U={root:Q},G=n.forwardRef(({className:r,style:d,errors:j,onFormSubmit:C,validationMode:I,onSubmit:g,action:p,method:B,disabled:R,children:E,...l},c)=>{const x=typeof r=="function"?a=>N(U.root,r(a)):N(U.root,r),b=typeof d=="function"?a=>({...d(a)}):d;return e.jsx(K,{ref:c,className:x,style:b,errors:j,onFormSubmit:C,validationMode:I,onSubmit:g,action:p,method:B,...l,children:E})});G.displayName="Form";const m=G;G.__docgenInfo={description:"",methods:[],displayName:"Form",props:{errors:{required:!1,tsType:{name:"BaseFormProps['errors']",raw:"BaseFormProps<Record<string, unknown>>['errors']"},description:"Validation errors keyed by field name (e.g. from server or schema).\nKeys should match the `name` attribute on form controls."},onFormSubmit:{required:!1,tsType:{name:"BaseFormProps['onFormSubmit']",raw:"BaseFormProps<Record<string, unknown>>['onFormSubmit']"},description:`Called when form is submitted with values as an object.
...
}`,...w.parameters?.docs?.source},description:{story:"Custom className and style are merged with root styles.",...w.parameters?.docs?.description}}};const Fe=["Default","WithOnFormSubmit","WithErrors","ValidationModeOnBlur","Disabled","CustomStyling"];export{w as CustomStyling,h as Default,S as Disabled,v as ValidationModeOnBlur,F as WithErrors,y as WithOnFormSubmit,Fe as __namedExportsOrder,ye as default};
