import"./iframe-Da2YPWL1.js";import{C as s}from"./Slider-BoQu4j2D.js";import"./preload-helper-Ct5FWWRu.js";import"./jsx-runtime-D_zvdyIk.js";import"./index-C1quyIeQ.js";const u={title:"Form/Slider",component:s,tags:["autodocs"],argTypes:{min:{control:{type:"number"}},max:{control:{type:"number"}},step:{control:{type:"number"}},defaultValue:{control:{type:"number"}},disabled:{control:{type:"boolean"}},label:{control:{type:"text"}}},parameters:{controls:{expanded:!0}}},e={args:{min:0,max:100,step:1,defaultValue:50}},a={args:{min:0,max:100,step:10,defaultValue:50}},r={args:{min:0,max:100,step:1,defaultValue:50,label:"Test"}},t={args:{min:0,max:100,step:1,defaultValue:50,disabled:!0}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    min: 0,
    max: 100,
    step: 1,
