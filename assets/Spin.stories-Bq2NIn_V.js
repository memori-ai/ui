import{j as r,R as x}from"./iframe-BwstfbU_.js";import{S as n}from"./Spin-hzlxyqDr.js";import{B as g}from"./Button-C0C54PdK.js";import"./preload-helper-Ct5FWWRu.js";import"./index-CHh8EnzU.js";import"./loader-circle-AJFpR8cz.js";import"./createLucideIcon-bqJrGWO7.js";import"./useButton-BUEON4ru.js";import"./useRenderElement-DcA6ERQ4.js";const L={title:"Components/Spin",component:n,tags:["autodocs"],argTypes:{spinning:{control:{type:"boolean"},description:"Whether the spinner is visible"},primary:{control:{type:"boolean"},description:"If true, uses the primary color for the spinner"},size:{control:{type:"select"},options:["sm","md","lg","default"],description:"Size of the spinner icon"},tip:{control:{type:"text"},description:"Tip text displayed below the spinner"}},parameters:{controls:{expanded:!0},docs:{description:{component:"A loading spinner component that displays an overlay with a spinning icon. Built with full accessibility support (WCAG 2.1 AA+)."}}},render:e=>r.jsx("div",{style:{minHeight:"200px",padding:"1rem"},children:r.jsx(n,{...e,children:r.jsxs("div",{style:{padding:"2rem",border:"1px solid var(--memori-primary-subtle)",borderRadius:"var(--memori-radius-surface)"},children:[r.jsx("p",{children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit."}),r.jsx("h2",{children:"Suspendisse a sodales nulla, sed semper nisi."}),r.jsx("p",{children:"Proin tincidunt enim in felis aliquet, a ultricies purus bibendum."}),r.jsxs("ul",{children:[r.jsx("li",{children:"Quisque in ultrices lectus."}),r.jsx("li",{children:"Quisque in ultrices lectus."}),r.jsx("li",{children:"Quisque in ultrices lectus."})]}),r.jsx("p",{children:"Nulla at urna diam."})]})})})},i={args:{spinning:!1}},s={args:{spinning:!0}},t={args:{spinning:!0,primary:!0}},a={args:{spinning:!0,tip:"Loading content..."}},o={args:{spinning:!0,size:"sm"}},p={args:{spinning:!0,size:"md"}},d={args:{spinning:!0,size:"lg"}},c={args:{spinning:!0,primary:!0},render:e=>r.jsx(n,{...e,children:r.jsx(g,{children:"Click me"})})},m={args:{spinning:!0,indicator:r.jsx("div",{style:{width:"40px",height:"40px",border:"4px solid var(--memori-primary)",borderTopColor:"transparent",borderRadius:"50%",animation:"memori-spin-rotate var(--memori-motion-duration-loop) var(--memori-motion-ease-linear) infinite"},"aria-hidden":"true"})}},u={render:()=>{const[e,h]=x.useState(!1);return r.jsxs("div",{children:[r.jsxs(g,{onClick:()=>h(!e),style:{marginBottom:"1rem"},children:[e?"Stop":"Start"," Loading"]}),r.jsx(n,{spinning:e,tip:"Processing...",children:r.jsxs("div",{style:{padding:"2rem",border:"1px solid var(--memori-primary-subtle)",borderRadius:"var(--memori-radius-surface)"},children:[r.jsx("p",{children:"This content is being loaded."}),r.jsxs("p",{children:["Current state: ",e?"Loading":"Ready"]})]})})]})}},l={args:{spinning:!0,primary:!0},render:e=>r.jsx(n,{...e,children:r.jsx("div",{style:{padding:"1rem"},children:r.jsx("p",{children:"Minimal content example"})})})};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  ...
  args: {
    ...
    indicator: <div style={{
      ...
      borderRadius: '50%',
      animation: 'memori-spin-rotate var(--memori-motion-duration-loop) var(--memori-motion-ease-linear) infinite'
    }} aria-hidden="true" />
  }
...
}`,...l.parameters?.docs?.source}}};const z=["Default","Spinning","Primary","WithTip","Small","Medium","Large","WithButton","WithCustomIndicator","Controlled","MinimalContent"];export{u as Controlled,i as Default,d as Large,p as Medium,l as MinimalContent,t as Primary,o as Small,s as Spinning,c as WithButton,m as WithCustomIndicator,a as WithTip,z as __namedExportsOrder,L as default};
