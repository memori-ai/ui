import{i as e,w as t}from"./iframe-Bi_xfY0J.js";import{t as n}from"./jsx-runtime-BiOnZeK0.js";import"./shim-nS__OUsy.js";import"./open-closed-YCM9D4cj.js";import"./floating-ui.utils.dom-CMQ-BUtD.js";import{t as r}from"./transition-B3inxJCz.js";import{t as i}from"./classnames-Bq-rLKjT.js";import"./createLucideIcon-CXV7GNKR.js";import{t as a}from"./x-hsH1pdhD.js";import"./useRenderElement-DJv_xvK7.js";import"./useButton-B_LbQleG.js";import{t as o}from"./Button-BU34mPj9.js";import"./Button-DJlKJpMK.js";import{t as s}from"./useTranslation-BSgQnUVl.js";var c=t(i(),1),l=t(e(),1),u=n(),d=({open:e=!1,onClose:t,className:n,title:i,description:d,children:f,type:p=`info`,icon:m,closable:h=!0,duration:g=null,action:_,width:v=`400px`})=>{let{t:y}=s();return l.useEffect(()=>{if(g&&e){let e=setTimeout(()=>{t(!1)},g);return()=>clearTimeout(e)}},[g,e,t]),(0,u.jsx)(r,{show:e,as:l.Fragment,appear:!0,children:(0,u.jsxs)(`div`,{className:(0,c.default)(`memori-alert`,(e=>{switch(e){case`success`:return`memori-alert--success`;case`warning`:return`memori-alert--warning`;case`error`:return`memori-alert--error`;default:return`memori-alert--info`}})(p),n),children:[(0,u.jsx)(`style`,{dangerouslySetInnerHTML:{__html:`
              .memori-alert {
