import{i as e,w as t}from"./iframe-tXXeCmse.js";import{t as n}from"./jsx-runtime-D3fcwA20.js";import"./shim-DtHk-umd.js";import"./open-closed-DZ_p380R.js";import"./floating-ui.utils.dom-DXR4vcPl.js";import{t as r}from"./transition-DZCHpjsk.js";import{t as i}from"./classnames-BMcGO9Ah.js";import"./createLucideIcon-CUXl81fu.js";import{t as a}from"./x-B6WQxTsI.js";import"./useRenderElement-C08tm2PC.js";import{t as o}from"./Button-QjAYfA66.js";import"./Button-DJlKJpMK.js";import{t as s}from"./useTranslation-D-Dmqzda.js";var c=t(i(),1),l=t(e(),1),u=n(),d=({open:e=!1,onClose:t,className:n,title:i,description:d,children:f,type:p=`info`,icon:m,closable:h=!0,duration:g=null,action:_,width:v=`400px`})=>{let{t:y}=s();return l.useEffect(()=>{if(g&&e){let e=setTimeout(()=>{t(!1)},g);return()=>clearTimeout(e)}},[g,e,t]),(0,u.jsx)(r,{show:e,as:l.Fragment,appear:!0,children:(0,u.jsxs)(`div`,{className:(0,c.default)(`memori-alert`,(e=>{switch(e){case`success`:return`memori-alert--success`;case`warning`:return`memori-alert--warning`;case`error`:return`memori-alert--error`;default:return`memori-alert--info`}})(p),n),children:[(0,u.jsx)(`style`,{dangerouslySetInnerHTML:{__html:`
              .memori-alert {
