import{i as e,w as t}from"./iframe-D2QKfIa5.js";import"./react-dom-s7pOHX4f.js";import{t as n}from"./jsx-runtime-BItSYGdv.js";import"./open-closed-BZSBcn7w.js";import"./portal-Bk2fYbmF.js";import"./dialog-CbjRIUvQ.js";import"./floating-ui.utils.dom-TkEs6LFG.js";import"./transition-BPbrc6g7.js";import"./classnames-DfTMaiYv.js";import"./useRenderElement-fh6yNlsC.js";import{t as r}from"./Button-DIWKn8rT.js";import"./Button-DIRJwf5Q.js";import{t as i}from"./ConfirmDialog-kkNI4q4-.js";var a=t(e(),1),o=n(),s={title:`UI/ConfirmDialog`,component:i,tags:[`autodocs`],argTypes:{isOpen:{control:{type:`boolean`}},title:{control:{type:`text`}},message:{control:{type:`text`}},confirmText:{control:{type:`text`}},cancelText:{control:{type:`text`}}},parameters:{controls:{expanded:!0}}};const c={args:{isOpen:!1,onClose:()=>{},onConfirm:()=>{},title:`Confirm Action`,message:`Are you sure you want to proceed with this action?`,confirmText:`Confirm`,cancelText:`Cancel`}},l={args:{isOpen:!0,onClose:()=>{},onConfirm:()=>{},title:`Confirm Action`,message:`Are you sure you want to proceed with this action?`,confirmText:`Confirm`,cancelText:`Cancel`}},u={args:{isOpen:!0,onClose:()=>{},onConfirm:()=>{},title:`Delete Item`,message:`Are you sure you want to proceed with this action?`,confirmText:`Confirm`,cancelText:`Cancel`}},d={args:{isOpen:!0,onClose:()=>{},onConfirm:()=>{},title:`Confirm Action`,message:`This action cannot be undone. All associated data will be permanently deleted from the system.`,confirmText:`Confirm`,cancelText:`Cancel`}},f={args:{isOpen:!0,onClose:()=>{},onConfirm:()=>{},title:`Delete Item`,message:`Are you sure you want to delete this item? This action cannot be undone.`,confirmText:`Yes, Delete`,cancelText:`No, Keep It`}};var p=e=>{let[t,n]=a.useState(!1),[s,c]=a.useState(!1),l=()=>{c(!0),n(!1),console.log(`Item deleted!`)};return(0,o.jsxs)(o.Fragment,{children:[s?(0,o.jsx)(`div`,{style:{padding:`12px`,background:`#f8d7da`,color:`#721c24`,borderRadius:`4px`,marginBottom:`20px`},children:`Item has been deleted successfully!`}):(0,o.jsx)(r,{onClick:()=>n(!0),children:`Delete Item`}),(0,o.jsx)(i,{...e,isOpen:t,onClose:()=>n(!1),onConfirm:l})]})};const m={args:{isOpen:!0,onClose:()=>{},onConfirm:()=>{},title:`Delete Item`,message:`Are you sure you want to delete this item? This action cannot be undone.`,confirmText:`Delete`,cancelText:`Cancel`},render:e=>(0,o.jsx)(p,{...e})};var h=e=>{let[t,n]=a.useState(!1),[s,c]=a.useState(!1),l=()=>{n(!0)},u=()=>{c(!0),n(!1),console.log(`Navigated without saving!`)};return(0,o.jsxs)(o.Fragment,{children:[s?(0,o.jsx)(`div`,{style:{padding:`12px`,background:`#d4edda`,color:`#155724`,borderRadius:`4px`,marginBottom:`20px`},children:`Navigated away without saving changes.`}):(0,o.jsxs)(`div`,{children:[(0,o.jsxs)(`div`,{style:{padding:`20px`,border:`1px solid #ddd`,borderRadius:`4px`,marginBottom:`20px`},children:[(0,o.jsx)(`h3`,{children:`Unsaved Form`}),(0,o.jsx)(`p`,{children:`This is a form with unsaved changes.`}),(0,o.jsx)(`input`,{type:`text`,placeholder:`Your name`,style:{padding:`8px`,marginBottom:`10px`,width:`100%`}}),(0,o.jsx)(`textarea`,{placeholder:`Your message`,style:{padding:`8px`,width:`100%`,height:`100px`}})]}),(0,o.jsx)(r,{onClick:l,children:`Navigate Away`})]}),(0,o.jsx)(i,{...e,isOpen:t,onClose:()=>n(!1),onConfirm:u})]})};const g={args:{isOpen:!0,onClose:()=>{},onConfirm:()=>{},title:`Unsaved Changes`,message:`You have unsaved changes. Are you sure you want to leave without saving?`,confirmText:`Leave`,cancelText:`Stay`},render:e=>(0,o.jsx)(h,{...e})};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  args: {
    isOpen: false,
    onClose: () => {},
    onConfirm: () => {},
