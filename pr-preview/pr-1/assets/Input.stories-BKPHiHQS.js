import{i as e,w as t}from"./iframe-CFC9aqhH.js";import{t as n}from"./react-dom-B-gqWu6k.js";import{t as r}from"./jsx-runtime-BBrtUeq_.js";import{d as i}from"./floating-ui.utils.dom-CMQ-BUtD.js";import{t as a}from"./classnames-C7dOIbnZ.js";import{a as o,c as s,d as c,f as l,i as u,t as d}from"./useRenderElement-BxLFoW0x.js";import{n as f,s as p}from"./useId-D00QeLAj.js";import{t as m}from"./useBaseUiId-DfOy_JuU.js";var h=t(e());function g({controlled:e,default:t,name:n,state:r=`value`}){let{current:i}=h.useRef(e!==void 0),[a,o]=h.useState(t);return[i?e:a,h.useCallback(e=>{i||o(e)},[])]}let _=function(e){return e.disabled=`data-disabled`,e.valid=`data-valid`,e.invalid=`data-invalid`,e.touched=`data-touched`,e.dirty=`data-dirty`,e.filled=`data-filled`,e.focused=`data-focused`,e}({});const v={badInput:!1,customError:!1,patternMismatch:!1,rangeOverflow:!1,rangeUnderflow:!1,stepMismatch:!1,tooLong:!1,tooShort:!1,typeMismatch:!1,valid:null,valueMissing:!1},y={valid(e){return e===null?null:e?{[_.valid]:``}:{[_.invalid]:``}}},b=h.createContext({invalid:void 0,name:void 0,validityData:{state:v,errors:[],error:``,value:``,initialValue:null},setValidityData:o,disabled:void 0,touched:!1,setTouched:o,dirty:!1,setDirty:o,filled:!1,setFilled:o,focused:!1,setFocused:o,validate:()=>null,validationMode:`onSubmit`,validationDebounceTime:0,shouldValidateOnChange:()=>!1,state:{disabled:!1,valid:null,touched:!1,dirty:!1,filled:!1,focused:!1},markedDirtyRef:{current:!1},validation:{getValidationProps:(e=u)=>e,getInputValidationProps:(e=u)=>e,inputRef:{current:null},commit:async()=>{}}});function x(e=!0){let t=h.useContext(b);if(t.setValidityData===o&&!e)throw Error(s(28));return t}function S(e,t){return{...e,state:{...e.state,valid:!t&&e.state.valid}}}const C=h.createContext({formRef:{current:{fields:new Map}},errors:{},clearErrors:o,validationMode:`onSubmit`,submitAttemptedRef:{current:!1}});function w(){return h.useContext(C)}var T=t(n());function E(e){let{enabled:t=!0,value:n,id:r,name:i,controlRef:a,commit:o}=e,{formRef:s}=w(),{invalid:u,markedDirtyRef:d,validityData:f,setValidityData:p}=x(),m=l(e.getValue);c(()=>{if(!t)return;let e=n;e===void 0&&(e=m()),f.initialValue===null&&e!==null&&p(t=>({...t,initialValue:e}))},[t,p,n,f.initialValue,m]),c(()=>{!t||!r||s.current.fields.set(r,{getValue:m,name:i,controlRef:a,validityData:S(f,u),validate(){let e=n;e===void 0&&(e=m()),d.current=!0,T.flushSync(()=>o(e))}})},[o,a,t,s,m,r,u,d,i,f,n]),c(()=>{let e=s.current.fields;return()=>{r&&e.delete(r)}},[s,r])}const D=h.createContext({controlId:void 0,setControlId:o,labelId:void 0,setLabelId:o,messageIds:[],setMessageIds:o,getDescriptionProps:e=>e});function O(){return h.useContext(D)}function k(e={}){let{id:t,implicit:n=!1,controlRef:r}=e,{controlId:a,setControlId:s}=O(),l=m(t);return c(()=>{if(!(!n&&!t||s===o)){if(n){let e=r?.current;i(e)&&e.closest(`label`)!=null?s(t??null):s(a??l)}else t&&s(t);return()=>{t&&s(void 0)}}},[t,r,a,s,n,l]),a??l}const A=h.forwardRef(function(e,t){let{render:n,className:r,id:i,name:a,value:o,disabled:s=!1,onValueChange:u,defaultValue:m,..._}=e,{state:v,name:b,disabled:S}=x(),C=S||s,w=b??a,T=h.useMemo(()=>({...v,disabled:C}),[v,C]),{setTouched:D,setDirty:A,validityData:j,setFocused:M,setFilled:N,validationMode:P,validation:F}=x(),{labelId:I}=O(),L=k({id:i});c(()=>{let e=o!=null;F.inputRef.current?.value||e&&o!==``?N(!0):e&&o===``&&N(!1)},[F.inputRef,N,o]);let[R,z]=g({controlled:o,default:m,name:`FieldControl`,state:`value`}),B=o!==void 0,V=l((e,t)=>{u?.(e,t),!t.isCanceled&&z(e)});return E({id:L,name:w,commit:F.commit,value:R,getValue:()=>F.inputRef.current?.value,controlRef:F.inputRef}),d(`input`,e,{ref:t,state:T,props:[{id:L,disabled:C,name:w,ref:F.inputRef,"aria-labelledby":I,...B?{value:R}:{defaultValue:m},onChange(e){let t=e.currentTarget.value;V(t,f(p,e.nativeEvent)),A(t!==j.initialValue),N(t!==``)},onFocus(){M(!0)},onBlur(e){D(!0),M(!1),P===`onBlur`&&F.commit(e.currentTarget.value)},onKeyDown(e){e.currentTarget.tagName===`INPUT`&&e.key===`Enter`&&(D(!0),F.commit(e.currentTarget.value))}},F.getInputValidationProps(),_],stateAttributesMapping:y})});var j=r();const M=h.forwardRef(function(e,t){return(0,j.jsx)(A,{ref:t,...e})});var N=t(a(),1),P={input:`_input_ut1oa_1`,"input--default":`_input--default_ut1oa_30`,"input--error":`_input--error_ut1oa_39`,"input--disabled":`_input--disabled_ut1oa_54`,"input--sm":`_input--sm_ut1oa_72`,"input--md":`_input--md_ut1oa_78`,"input--lg":`_input--lg_ut1oa_84`,"input--full-width":`_input--full-width_ut1oa_94`};const F=h.forwardRef(({variant:e=`default`,size:t=`md`,fullWidth:n=!1,className:r,disabled:i,...a},o)=>{let s=i||e===`disabled`,c=e===`error`?P[`input--error`]:e===`disabled`?P[`input--disabled`]:P[`input--default`],l=t===`sm`?P[`input--sm`]:t===`lg`?P[`input--lg`]:P[`input--md`],u=n?P[`input--full-width`]:void 0,d=s?P[`input--disabled`]:void 0;return(0,j.jsx)(M,{ref:o,disabled:s,className:(0,N.default)(P.input,c,l,u,d,r),...a})});F.displayName=`Input`,F.__docgenInfo={description:``,methods:[],displayName:`Input`,props:{variant:{required:!1,tsType:{name:`union`,raw:`'default' | 'error' | 'disabled'`,elements:[{name:`literal`,value:`'default'`},{name:`literal`,value:`'error'`},{name:`literal`,value:`'disabled'`}]},description:`Input variant
