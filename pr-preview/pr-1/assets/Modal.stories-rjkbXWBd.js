import{i as e,w as t}from"./iframe-CFC9aqhH.js";import"./react-dom-B-gqWu6k.js";import{t as n}from"./jsx-runtime-BBrtUeq_.js";import"./shim-OtaSX_8J.js";import"./floating-ui.utils.dom-CMQ-BUtD.js";import"./floating-ui.react-dom-k0BR756v.js";import{t as r}from"./classnames-C7dOIbnZ.js";import"./createLucideIcon-DhNlEVyP.js";import{t as i}from"./Spin-DoxwXn2d.js";import{t as a}from"./x-CmsY5Mdk.js";import{t as o}from"./useRenderElement-BxLFoW0x.js";import{t as s}from"./Button-CedY-Fvs.js";import"./Button-D4JlI2PW.js";import"./useId-D00QeLAj.js";import{t as c}from"./useBaseUiId-DfOy_JuU.js";import{a as l,c as u,i as d,l as f,n as p,o as m,r as h,s as g,t as _,u as v}from"./DialogRoot-BkTPn8j5.js";var y=t(e());const b=y.forwardRef(function(e,t){let{render:n,className:r,id:i,...a}=e,{store:s}=f(),l=c(i);return s.useSyncedValueWithCleanup(`descriptionElementId`,l),o(`p`,e,{ref:t,props:[{id:l},a]})}),x=y.forwardRef(function(e,t){let{render:n,className:r,id:i,...a}=e,{store:s}=f(),l=c(i);return s.useSyncedValueWithCleanup(`titleElementId`,l),o(`h2`,e,{ref:t,props:[{id:l},a]})});let S=function(e){return e[e.open=g.open]=`open`,e[e.closed=g.closed]=`closed`,e[e.startingStyle=g.startingStyle]=`startingStyle`,e[e.endingStyle=g.endingStyle]=`endingStyle`,e.nested=`data-nested`,e.nestedDialogOpen=`data-nested-dialog-open`,e}({});var C={...u,...v,nested(e){return e?{[S.nested]:``}:null},nestedDialogOpen(e){return e?{[S.nestedDialogOpen]:``}:null}};const w=y.forwardRef(function(e,t){let{className:n,render:r,children:i,...a}=e,s=d(),{store:c}=f(),l=c.useState(`open`),u=c.useState(`nested`),p=c.useState(`transitionStatus`),m=c.useState(`nestedOpenDialogCount`),h=c.useState(`mounted`),g=m>0,_=y.useMemo(()=>({open:l,nested:u,transitionStatus:p,nestedDialogOpen:g}),[l,u,p,g]);return o(`div`,e,{enabled:s||h,state:_,ref:[t,c.useStateSetter(`viewportElement`)],stateAttributesMapping:C,props:[{role:`presentation`,hidden:!h,children:i},a]})});var T=t(r(),1),E={backdrop:`_backdrop_mo9hv_5`,viewport:`_viewport_mo9hv_20`,centered:`_centered_mo9hv_28`,popup:`_popup_mo9hv_39`,"popup--sm":`_popup--sm_mo9hv_62`,"popup--md":`_popup--md_mo9hv_67`,"popup--lg":`_popup--lg_mo9hv_72`,"popup--xl":`_popup--xl_mo9hv_77`,"popup--full":`_popup--full_mo9hv_82`,closeButton:`_closeButton_mo9hv_119`,title:`_title_mo9hv_157`,description:`_description_mo9hv_169`,content:`_content_mo9hv_181`,footer:`_footer_mo9hv_192`},D=n();const O=y.forwardRef(({open:e=!1,onOpenChange:t,title:n,description:r,children:o,footer:s,loading:c=!1,closable:u=!0,closeOnOverlayClick:d=!0,closeOnEsc:f=!0,size:g=`md`,width:v,widthMd:S,widthLg:C,centered:O=!0,modal:k=!0,disablePointerDismissal:A,initialFocus:j,finalFocus:M,onAfterOpen:N,onAfterClose:P,className:F,backdropClassName:I,contentClassName:L,titleClassName:R,descriptionClassName:z,footerClassName:B,style:V,contentStyle:H,id:U,"data-testid":W,"aria-label":G,"aria-labelledby":K,"aria-describedby":q,animated:J=!0,closeButton:Y,closeIcon:X,...Z},Q)=>{let $=y.useCallback((e,n)=>{!e&&!f&&n?.reason&&(n.reason===`escapeKey`||String(n.reason).includes(`escape`))||t?.(e)},[t,f]),ee=y.useCallback(e=>{e?N?.():P?.()},[N,P]),te=A===void 0?!d:A,ne={...v&&{maxWidth:typeof v==`number`?`${v}px`:v},...S&&{"--modal-width-md":typeof S==`number`?`${S}px`:S},...C&&{"--modal-width-lg":typeof C==`number`?`${C}px`:C},...H},re=g===`sm`?E[`popup--sm`]:g===`md`?E[`popup--md`]:g===`lg`?E[`popup--lg`]:g===`xl`?E[`popup--xl`]:g===`full`?E[`popup--full`]:void 0,ie=(0,T.default)(E.popup,re,L);return(0,D.jsx)(_,{open:e,onOpenChange:$,onOpenChangeComplete:ee,modal:k,disablePointerDismissal:te,...Z,children:(0,D.jsxs)(p,{children:[J&&(0,D.jsx)(m,{className:(0,T.default)(E.backdrop,I)}),(0,D.jsx)(w,{className:(0,T.default)(E.viewport,O&&E.centered,F),children:(0,D.jsxs)(h,{ref:Q,initialFocus:j,finalFocus:M,className:ie,style:ne,"data-testid":W,"aria-label":n?void 0:G,"aria-labelledby":n?void 0:K,"aria-describedby":r?void 0:q,...S&&{"data-width-md":``},...C&&{"data-width-lg":``},children:[u&&(Y?(0,D.jsx)(`div`,{className:E.closeButton,children:Y}):(0,D.jsx)(l,{className:E.closeButton,"aria-label":`Close modal`,children:X||(0,D.jsx)(a,{})})),(0,D.jsxs)(i,{spinning:c,children:[n&&(0,D.jsx)(x,{className:(0,T.default)(E.title,R),children:n}),r&&(0,D.jsx)(b,{className:(0,T.default)(E.description,z),children:r}),(0,D.jsx)(`div`,{className:E.content,children:o}),s&&(0,D.jsx)(`div`,{className:(0,T.default)(E.footer,B),children:s})]})]})})]})})});O.displayName=`Modal`;var k=O;O.__docgenInfo={description:``,methods:[],displayName:`Modal`,props:{open:{required:!1,tsType:{name:`boolean`},description:`Whether the modal is open
