import{i as e,w as t}from"./iframe-DMsFkDbs.js";import{t as n}from"./jsx-runtime-s6AK7i7Z.js";import{t as r}from"./classnames-D2mCmNFl.js";var i=t(r(),1);e();var a=n(),o=({content:e,className:t,align:n=`right`,disabled:r=!1,visible:o=!1,children:s})=>(0,a.jsxs)(`div`,{className:(0,i.default)(`memori-tooltip`,`memori-tooltip--align-${n}`,t,{"memori-tooltip--disabled":r,"memori-tooltip--visible":o}),children:[(0,a.jsx)(`div`,{className:`memori-tooltip__content`,children:e}),(0,a.jsx)(`div`,{className:`memori-tooltip__trigger`,children:s})]}),s=o;o.__docgenInfo={description:``,methods:[],displayName:`Tooltip`,props:{content:{required:!0,tsType:{name:`union`,raw:`string | JSX.Element | React.ReactNode`,elements:[{name:`string`},{name:`JSX.Element`},{name:`ReactReactNode`,raw:`React.ReactNode`}]},description:``},className:{required:!1,tsType:{name:`string`},description:``},align:{required:!1,tsType:{name:`union`,raw:`| 'left'
| 'right'
| 'topLeft'
| 'topRight'
| 'bottomLeft'
